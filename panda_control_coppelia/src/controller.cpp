...
void ArmController::compute()
{
	...
	if (control_mode_ == "joint_ctrl_home")
	{
		...
		double duration = 1.0;
		Vector3d project_translation; //프로젝트 경기장 좌표계로 이동
	...
	//	double norm = pointing.norm(); //distance 이기도 함
	...
	//	double norm_0_1 = pointing_0_1.norm(); //distance 이기도 함
	...
	//	double norm_1_2 = pointing_1_2.norm(); //distance 이기도 함
	...
	//	double norm_2_3 = pointing_2_3.norm(); //distance 이기도 함
